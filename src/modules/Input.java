...
;
    ...
    Output [] dataOutArray; //The dataInArray of this bundle is connected to which dataOutArray
    Output validArray = null; //The pValidArray of this bundle is connected to which validArray
    Output nReadyArray = null; //The readyArray (which is output) of this bundle is connected to which nReadyArray of which output bundle
