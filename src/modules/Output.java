...
public class Output implements Serializable
{
    ...
    static Output VCC = null;
    static Output GND = null;
    ...
    Input [] dataInArray; //The dataOutArray of this output bundle is connected to which input dataInArray
    Input pValidArray = null; //The validArray of this output bundle is connected to which input pValidArray
    Input readyArray = null; //The nReadyArray (input pin) of this output bundle is connected to which readyArray of which input bundle
