...
public class RouteSite {
    public static final int maxLUTs = 8;
    public static final int maxFlops = 16;

    public Site site;
    public String siteName; //This is not the device name but the name of the site user-defined
    public EDIFNet clkNet, rstNet;

    public Flop flops [] = new Flop [maxFlops];
    public LUT luts [] = new LUT [maxLUTs];
    public int flopsPlaced, lutsPlaced;
    public int flopsRouted, lutsRouted;

    public int layer; //This tells this site is in which layer of the pblock. +ve means in the top layer and -ve means in the bottom layer
