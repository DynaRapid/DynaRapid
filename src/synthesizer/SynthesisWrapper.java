...
public class SynthesisWrapper {
    ...
    public static void createWrapperWithCustomDataPorts(ModuleInst moduleInst, Node node, ModulePorts modulePorts, HashMap<Integer, String> dataInPortMapping, HashMap<Integer, String> dataOutPortMapping)
    {
        String portName = "";
        int index = 0;
    ...
    public static boolean wrapModule(String topName, Node node)
    {
