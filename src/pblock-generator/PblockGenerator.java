...
{
    Component component;
    boolean status; //tells the status of the pblock generator. True if all good else false
    boolean remove; //Tells if the un-successful pblock file are to be removed or not
    boolean shorten; //True if the pblock generation is to be done in shortened format
    int numShapes;
    boolean licence;
