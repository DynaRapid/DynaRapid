...
public class Node implements Serializable
{
    ...
    public long compValue;
    public boolean compControl;
    
    public int slots;
    public boolean transparent;
    public String mem;
    public int bbCount = -1;
    public int loadCount = -1;
    public int storeCount = -1;
    public int dataSize = 32;
    public int addressSize = 32;
    public boolean memAddress;
    public int bbID = -1;
    public int portID = -1;
    public int offset = -1;
    ...
    public EDIFCellInst moduleEDIFCellInst;

    //For Placement algorithm
    public Shape shape;
    public String topLeftAnchorLoc;
    public Site rwAnchorSite;
    public Tile rwAnchorTile;
    public String rwAnchorSiteName;
    public String rwAnchorTileName;
