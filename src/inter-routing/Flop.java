...
public class Flop {
    ...
    String flopName;
    Cell ffcell;
    EDIFCellInst ffCellInst;
    BEL bel;
    Site site;
    
    EDIFNet inputNet, rstNet, clkNet, outputNet, ceNet;

    //Flop Inputs
    EDIFCellInst inputEDIF, ceEDIF; //Incase the flop input is connected to a design port then this holds null
    String inputPortName, cePortName; //Incase the flop input is connected to a design port then this holds ""

    //Flop Outputs
    ArrayList<EDIFCellInst> outputEDIF; //In case the flop output holds a design port then it is of size 0
    ArrayList<String> outputPortName; //In case the flop is connected to a design port, the name is mentioned here.
