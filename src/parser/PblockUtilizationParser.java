...
public class PblockUtilizationParser {
    ...
    final static String checkStrings[] = {
        "| CLB LUTs", //0
        "|   CLBL", //1
        "|   CLBM", //2
        "|   DSP48E2 only" //3
    ...
    final static String resourceNames[] = {
        "CLB LUTs",
        "CLEL",
        "CLEM",
        "DSP48E2",
    ...
    int resourcesUsed[]; //Amount of resources used in the pblock. Populated by PblockUtilizationParser(). The order of elements are [CLB LUTs, CLEL, CLEM, DSP48E2]
    int resourcesAvail[]; //Amount of the resources available in the pblock. Populated by function populateResourcesAvailable(). The order of elements are [CLB LUTs, CLEL, CLEM, DSP48E2]
    boolean status = true; //If the resources list and variable are safe to use or not
