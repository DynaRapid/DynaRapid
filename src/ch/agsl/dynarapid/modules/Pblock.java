...
public class Pblock implements Serializable
{
    ...
    public Site anchorSite;
    public String anchorName; //This finally stores the name of the tile in which the anchor site is present
    public HashSet<Site> validPlaces;
